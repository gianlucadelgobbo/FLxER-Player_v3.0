class flxerGallery.flxerPlayerStyles extends MovieClip {
	...
	function flxerPlayerStyles(trgt, myName, x, y, w, h, col) {
		...
		toolsColors["colorBkgOver"] = 0xFF0000;
		/// MENU ///
		...
		styles.setStyle(".typeLabel", {fontFamily:'myFont', fontSize:'8px', color:'#FFFFFF', marginLeft:'3px'});
