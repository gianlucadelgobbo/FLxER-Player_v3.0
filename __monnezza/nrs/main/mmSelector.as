class main.mmSelector extends MovieClip {
	var x:Number;
	var y:Number;
	var w:Number;
	var h:Number;
	...
	function mySlidesShow() {
		...
		this._parent["mySuperPlayer"].avvia(lista);
		this._visible = false;
	}
	...
	function myOnOver(a) {
		if (oldA != undefined) {
			this["puls"+oldA].trgt._xscale = 100;
			this["puls"+oldA].trgt._yscale = 100;
			this["puls"+oldA].trgt._x = 0;
			this["puls"+oldA].trgt._y = 0;
		}
		this["puls"+a].trgt._xscale = 92;
		this["puls"+a].trgt._yscale = 89.2;
		this["puls"+a].trgt._x = 5;
		this["puls"+a].trgt._y = 5;
		oldA = a;
	}
}
