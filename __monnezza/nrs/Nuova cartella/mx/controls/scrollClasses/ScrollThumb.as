...
{
    var useHandCursor, ymin, ymax, datamin, datamax, _ymouse, lastY, scrollMove, _y, _parent, onMouseMove, grip_mc, gripSkin;
    ...
    function dragThumb(Void)
    {
        ...
        _y = scrollMove;
        var _l2 = Math.round((datamax - datamin) * (_y - ymin) / (ymax - ymin)) + datamin;
        _parent.scrollPosition = _l2;
