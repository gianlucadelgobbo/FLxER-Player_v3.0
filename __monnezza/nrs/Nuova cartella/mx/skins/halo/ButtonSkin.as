class mx.skins.halo.ButtonSkin extends mx.skins.RectBorder
{
    ...
    {
        var _l6 = this.getStyle("borderStyle");
        var _l4 = this.getStyle("themeColor");
        var _l5 = _parent.emphasized;
        this.clear();
        switch (_l6)
        {
            case "falseup":
            {
                if (_l5)
                {
                    ...
                    this.drawRoundRect(this.__get__x(), this.__get__y(), w, h, 5, _l4, 75);
                    ...
                    this.drawRoundRect(this.__get__x() + 2, this.__get__y() + 2, w - 4, h - 4, 3, _l4, 75);
            ...
            case "falsedown":
            {
                ...
                this.drawRoundRect(this.__get__x() + 1, this.__get__y() + 1, w - 2, h - 2, 4, _l4, 50);
                this.drawRoundRect(this.__get__x() + 2, this.__get__y() + 2, w - 4, h - 4, 3, [0, 14342874], 100, 0, "radial");
                this.drawRoundRect(this.__get__x(), this.__get__y(), w, h, 5, _l4, 40);
                this.drawRoundRect(this.__get__x() + 3, this.__get__y() + 3, w - 6, h - 6, 2, 16777215, 100);
                this.drawRoundRect(this.__get__x() + 3, this.__get__y() + 4, w - 6, h - 7, 2, _l4, 20);
                break;
            } 
            case "falserollover":
            {
                this.drawRoundRect(this.__get__x(), this.__get__y(), w, h, 5, 9542041, 100);
                this.drawRoundRect(this.__get__x(), this.__get__y(), w, h, 5, _l4, 50);
                this.drawRoundRect(this.__get__x() + 1, this.__get__y() + 1, w - 2, h - 2, 4, [3355443, 16777215], 100, 0, "radial");
                this.drawRoundRect(this.__get__x() + 2, this.__get__y() + 2, w - 4, h - 4, 3, [0, 14342874], 100, 0, "radial");
                this.drawRoundRect(this.__get__x() + 2, this.__get__y() + 2, w - 4, h - 4, 3, _l4, 50);
                this.drawRoundRect(this.__get__x() + 3, this.__get__y() + 3, w - 6, h - 6, 2, 16777215, 100);
                this.drawRoundRect(this.__get__x() + 3, this.__get__y() + 4, w - 6, h - 7, 2, 16316664, 100);
                break;
            } 
            ...
            case "truerollover":
            {
                ...
                this.drawRoundRect(this.__get__x(), this.__get__y(), w, h, 5, _l4, 50);
                this.drawRoundRect(this.__get__x() + 1, this.__get__y() + 1, w - 2, h - 2, 4, [3355443, 16777215], 100, 0, "radial");
                this.drawRoundRect(this.__get__x() + 1, this.__get__y() + 1, w - 2, h - 2, 4, _l4, 40);
                this.drawRoundRect(this.__get__x() + 2, this.__get__y() + 2, w - 4, h - 4, 3, [0, 14342874], 100, 0, "radial");
                this.drawRoundRect(this.__get__x() + 2, this.__get__y() + 2, w - 4, h - 4, 3, _l4, 40);
                this.drawRoundRect(this.__get__x() + 3, this.__get__y() + 3, w - 6, h - 6, 2, 16777215, 100);
                this.drawRoundRect(this.__get__x() + 3, this.__get__y() + 4, w - 6, h - 7, 2, 16316664, 100);
                break;
            } 
