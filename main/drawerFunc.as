class main.drawerFunc extends MovieClip {
	...
	function textDrawerSP(trgt, myName, txt, x, y, w, h, myEmbed) {
		...
		trgt[myName].backgroundColor = _root.myFlxerPlayerStyles.testo["colorBkg"];
		trgt[myName].borderColor = _root.myFlxerPlayerStyles.testo["colorBorder"];
		trgt[myName].styleSheet = _root.myFlxerPlayerStyles.styles;
